 ...
 * @author nkill
 */
public class frmPhonesReport extends javax.swing.JFrame {

    /**
     * Creates new form frmPhonesReport
     */
    public frmPhonesReport() {
        initComponents();
    }
    ...
    private void btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintActionPerformed
        readyFunctions.reportPrint(tblPhones, "Phones");
    }//GEN-LAST:event_btnPrintActionPerformed

    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        db.go.fillToJTable("employee_phones_data", tblPhones);
        readyFunctions.setReportColor(tblPhones);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmPhonesReport.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmPhonesReport().setVisible(true);
            }
        });
    }
